...
import { useVilla, useVillas } from '@/src/api';
import { BackButton, BookButton } from '@/src/components';
import { colors, layout, spacing } from '@/src/core';
import { VillaDetailOtherList } from '@/src/screens/villa-detail/villa-detail-other-list';
import { VillaDetailPriceCard } from '@/src/screens/villa-detail/villa-detail-price-card';
import { VillaDetailSkeleton } from '@/src/screens/villa-detail/villa-detail-skeleton';
import { VillaDetailSpecs } from '@/src/screens/villa-detail/villa-detail-specs';
    ...
    <>
      ...
      >
        <View style={styles.heroWrapper}>
          <Image source={{ uri: villa.image }} style={styles.heroImage} contentFit="cover" />
